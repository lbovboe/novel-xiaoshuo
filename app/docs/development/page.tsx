      ...
      >
          ...
          <DocList
            items={[
              <>
                ...
                <ul className="text-light-text/90 dark:text-dark-text/90 ml-6 mt-2 list-disc space-y-1">
                  <li>
        ...
        <DocSection title="Core Functionality" delay={2}>
          ...
          <DocSubSection title="Web Application" delay={2}>
            <p className="text-light-text/90 dark:text-dark-text/90 mb-4">The Next.js application provides:</p>
            <DocList
              items={[
        ...
        <DocSection title="Building and Deployment" delay={3}>
          <p className="text-light-text/90 dark:text-dark-text/90 mb-4">To build the application:</p>
          <DocCodeBlock code="npm run build" />
          <p className="text-light-text/90 dark:text-dark-text/90 mt-4">
